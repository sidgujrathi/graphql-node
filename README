...
### src/
 ...
 - ***modules***
	 This folder will hold all modules of project strcutured in folder with name of modules
	
	- *`typedef.index.js`*  file is entry point from which all typeDefs from all other modules to be exported.
	- *`resolvers.index.js`* file is entry point from which all resolvers to be exported from modules.
	- *`mutations.index.js`* file is entry point from which all mutations to be exported from modules.
 - ***lib***
